...
**프로젝트 후보**:
- 강의·트랙 기반 AI 솔루션 1개 (산업 데이터 기반)
- 예시: 문서 자동 분류 / 응답 자동화 / 인사이트 리포트 자동 생성
...
**포트폴리오 구성**:
- ✅ Stage 4 파이널 프로젝트 (산업 데이터 기반)
- ✅ GitHub 코드 + 위키 (yeardream-wiki)
- ✅ 미션 2 자동화 (크롤링·cron·GitHub Actions)

**옵션**:
1. **인턴십 / 취업** — AI Agent 엔지니어 직무
2. **대학원 / 연구** — Stage 4 프로젝트 확장
3. **해외 진출 기반** — 장기 진로
...
**Anthropic Korea**:
- Claude 만든 회사
- 준비: Claude API 활용 깊이 + GitHub 포트폴리오
