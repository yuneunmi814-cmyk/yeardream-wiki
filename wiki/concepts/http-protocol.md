...
sources: 1
related: [[app-web-services]], [[rest-api]], [[parsing]], [[synchronous-vs-asynchronous]]
---
...
→ 받은 문서에서 원하는 부분만 뽑는 건 [[parsing]] 영역.
...
- [[app-web-services]] — HTTP는 그 안의 통신 계층
- [[rest-api]] — HTTP 메서드 위에 세워진 API 설계 패턴
- [[parsing]] — JSON/XML 응답 파싱
- [[synchronous-vs-asynchronous]] — HTTP 요청의 두 가지 호출 방식
